   ...
   let personalpizza =  prompt("1-Pollo y Champiñones.  2-Hawaiana.  3-Carnes");
    ...
    switch (personalpizza) {
        ...
        if (borde == "no") {
            ...
            pedido.innerHTML = "Una pizza personal de pollo y champiñones " + " "  +  queso +   " " + salsa + " " + borde
        ...
        case "2":
            ...
            if (jamon == "no") {
                ...
                pedido.innerHTML = "Una pizza personal Hawaiana " + " " + pina + " " + jamon
        ...
        case "3":
            ...
            pedido.innerHTML = "Una pizza personal de caners " + " " + cabno + " " + salami
...
const pizzamediana = () => {
    ...
    switch (medianapizza) {
        case "1":
            ...
            pedido.innerHTML = "Una pizza mediana Mexicana " + " " + nachos + " " + mole
        ...
        case "2":
            ...
            if (queso == "no") {
                ...
                pedido.innerHTML = "Una pizza mediana Criolla " + " " + carne + " " + queso
...
const pizzafamiliar = () => {
    ...
    switch (familiarpizza) {
        ...
        case "2":
            ...
            pedido.innerHTML = "Una pizza familiar de Carne y Pollo " + " " + salchicha + " " + champ
